...
#define CYAN    RGB(4, 22, 21)
#define MAGENTA RGB(31, 0, 31)
#define YELLOW  RGB(26, 26, 0)
#define BROWN   RGB(20, 10, 5)
#define ORANGE  RGB(31, 17, 0)

//epic cool colors
#define OFFWHITE RGB(28,29,30)
#define PORTAGE RGB(18,19,27)
#define SKYBLUE RGB(17,27,31)
#define BRULEE RGB(31,27,18)
#define CADILLAC RGB(19,9,13)
