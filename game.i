...
unsigned short colors[8] = {(((31) & 31) | ((0) & 31) << 5 | ((0) & 31) << 10), (((31) & 31) | ((17) & 31) << 5 | ((0) & 31) << 10), (((26) & 31) | ((26) & 31) << 5 | ((0) & 31) << 10), (((0) & 31) | ((31) & 31) << 5 | ((0) & 31) << 10), (((0) & 31) | ((0) & 31) << 5 | ((31) & 31) << 10), (((4) & 31) | ((22) & 31) << 5 | ((21) & 31) << 10), (((0) & 31) | ((16) & 31) << 5 | ((16) & 31) << 10), (((31) & 31) | ((0) & 31) << 5 | ((31) & 31) << 10)};
...
void drawPlayer() {
    drawRectangle(player.oldX, player.oldY, player.width, player.height, (((28) & 31) | ((29) & 31) << 5 | ((30) & 31) << 10));
    drawRectangle(player.x, player.y, player.width, player.height, player.color);
}


void drawBall() {
    drawRectangle(ball.oldX, ball.oldY, ball.width, ball.height, (((28) & 31) | ((29) & 31) << 5 | ((30) & 31) << 10));
...
void drawBlocks() {
    for (int i=0; i < 30; i++) {
        if (blocks[i].active) {
            drawRectangle(blocks[i].oldX, blocks[i].oldY, blocks[i].width, blocks[i].height, (((28) & 31) | ((29) & 31) << 5 | ((30) & 31) << 10));
            drawRectangle(blocks[i].x, blocks[i].y, blocks[i].width, blocks[i].height, blocks[i].color);
        } else if (blocks[i].needToErase) {
            drawRectangle(blocks[i].x, blocks[i].y, blocks[i].width, blocks[i].height, (((28) & 31) | ((29) & 31) << 5 | ((30) & 31) << 10));
